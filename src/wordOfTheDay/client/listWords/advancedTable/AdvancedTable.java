...
public class AdvancedTable extends Composite {
	...
	private static final String DEFAULT_TABLE_WIDTH = "100px";
	private static final String DEFAULT_TABLE_HEIGHT = "410px";
	...
	public AdvancedTable() {
		...
		grid.setStyleName("advancedTable");
		...
		statusLabel.setStyleName("wordOfTheDayRight");
		navigationPanel.add(statusLabel);
		statusLabel.setHeight("20px");
		navigationPanel.setCellHeight(statusLabel, "23px");
		navigationPanel.setCellHorizontalAlignment(statusLabel,
				HasHorizontalAlignment.ALIGN_RIGHT);
		navigationPanel.setCellVerticalAlignment(statusLabel,
				HasVerticalAlignment.ALIGN_BOTTOM);
		...
		navigationPanel.setCellHorizontalAlignment(buttonFirstPage,
				HasHorizontalAlignment.ALIGN_RIGHT);
		...
		navigationPanel.setCellHorizontalAlignment(buttonPrevPage,
				HasHorizontalAlignment.ALIGN_RIGHT);
		...
		navigationPanel.setCellHorizontalAlignment(buttonNextPage,
				HasHorizontalAlignment.ALIGN_RIGHT);
		...
		navigationPanel.setCellHorizontalAlignment(buttonLastPage,
				HasHorizontalAlignment.ALIGN_RIGHT);
	...
	public void addCheckBoxesListener(CheckBoxesListener listener) {
			...
			public void onFailure(Throwable caught) {
				AdvancedTable.this.showStatus(
						"Can not get table rows count from the server."
								+ caught.getMessage(), STATUS_ERROR);
			}
	...
	private void checkBoxChanged(int row, boolean checked) {
		...
		if (checked) {
			...
			grid.getRowFormatter().setStyleName(row + 1, CHECKED_ROW_STYLE);
		} else {
			this.markedRows.remove(rowId);
			grid.getRowFormatter().setStyleName(row + 1, DEFAULT_ROW_STYLE);
		}
		this.checkBoxesListener.checkBoxesChanged(!this.markedRows.isEmpty());
	}
