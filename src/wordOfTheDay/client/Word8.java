...
public class Word8 implements IsSerializable, Serializable, Comparable<Word8> {
	private String name;
	...
	public Word8(String name, String explanation, List<String> usage, int date,
	...
	public int compareTo(Word8 compared) {
