...
public final class ValidationManager {
	public static Text validate(String input) {
		...
		return new Text(new String(charsInput));
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("janhorabik@gmail.com: "
				+ emailIsValid("janhorabik@gmail.com"));
		System.out.println("janhorabikgmail.com: "
				+ emailIsValid("janhorabikgmail.com"));
		System.out.println("janhorabik@gmail: "
				+ emailIsValid("janhorabik@gmail"));
	}
